  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocurrió un problema. Puede reintentar o volver al inicio.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SIGOC — Gestión de Proyectos Civiles" },
      {
        ...
        content:
          "Control centralizado de presupuestos, avance físico y financiero, documentos y APU por roles.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "theme-color", content: "#1C2433" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "SIGOC" },
      { name: "application-name", content: "SIGOC" },
    ],
    links: [
      {
        rel: "stylesheet",
